% Extract data from 4-panel figure
% Each panel has: black circle, green solid line, black dotted line
clear; clc; close all;
...
for sp = 1:4
    ...
    %% Save to MAT file
    output_file = fullfile(img_path, [subplot_names{sp} '_Patrick2022_Figure10_extracted_data.mat']);
...
boundary_file = fullfile(img_path, 'plot_boundaries.mat');
