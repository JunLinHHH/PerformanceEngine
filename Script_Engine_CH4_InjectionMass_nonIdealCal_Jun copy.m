...
for i = 1:height(data)
    ...
    P_diff = data.PressureRiseDueToCH4Injection_bar_P_diff(i)*1e5; % Pressure rise due to CH4 injection
    ...
    Z = calculateZ(P_total, T, V, P_c_CH4, T_c_CH4, omega_CH4); % Compressibility factor at P2
